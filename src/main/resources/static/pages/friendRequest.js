...
(async () => {
    ...
    const currentUserId = document.querySelector(".userprofile").dataset.userId;
        ...
        const url = `http://10.81.0.227:8080/getFriendRequest/${currentUserId}`;
        ...
        result.forEach(user => {
            ...
            divpersonRequestProfilePicture.style.backgroundImage = `url("http://10.81.0.227:8080/getProfilePic/${id}.png")`;
...
(() => {
    ...
    document.addEventListener("click", async (event) => {
        ...
        if (event.target.closest(".accept")) {
            ...
            const url = `http://10.81.0.227:8080/acceptFriendRequest/${idFromFriendRequest}/${currentUserId}`;
